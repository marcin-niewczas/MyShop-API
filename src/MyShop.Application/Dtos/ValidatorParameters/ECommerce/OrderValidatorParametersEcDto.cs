...
public sealed record OrderValidatorParametersEcDto : IDto
{
    ...
    public IReadOnlyCollection<string> AllowedPaymentMethods { get; }
        = PaymentMethod.AllowedValues.OfType<string>().ToArray();
    public IReadOnlyCollection<string> AllowedDeliveryMethods { get; }
        = DeliveryMethod.AllowedValues.OfType<string>().ToArray();
}
