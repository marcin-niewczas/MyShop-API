...
public sealed record CreateWebsiteHeroSectionItemMp : ICommand<ApiIdResponse>, IValidatable
{
    public Guid WebsiteHeroSectionId { get; init; }
    ...
    public void Validate(ICollection<ValidationMessage> validationMessages)
    {
        ...
        WebsiteHeroSectionItemPosition.Validate(Position, validationMessages);
    }
}
