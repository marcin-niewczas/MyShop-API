...
## About This Project
The main goal of **myShop API** project was to create a flexible e-commerce platform, that can be easily managed. The project has been built as REST API and developed with CQRS (Command Query Responsibility Segregation), Unit of Work and Event Driven Architecture Patterns.
